  ...
  grunt.initConfig({
    ...
    jsBundles: {
      ...
      '<%= buildDir %>/js/lib.js': [
        ...
        'lib/angular-bootstrap/dist/ui-bootstrap-tpls-0.7.0.js',
    ...
    copy: {
      resources: {
        files: [
          { expand:true, src: '**'           , dest: '<%= buildDir %>/fonts/' , cwd: 'fonts/' },
    ...
    html2js: {
      ...
      users: {
        src: [ 'js/uLearn/users/**/*.html' ],
        dest: '<%= buildDir %>/templates/users.js',
        module: 'users.templates'
      },
      diplomaWorkProposals: {
        src: [ 'js/uLearn/diplomaWorkProposals/**/*.html' ],
        dest: '<%= buildDir %>/templates/diplomaWorkProposals.js',
        module: 'diplomaWorkProposals.templates'
      },
      diplomaWorkReviews: {
